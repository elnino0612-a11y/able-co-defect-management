...
function App() {
  ...
  function removeRepairInputRow(id) {
    setRepairInputRows((prev) => {
      if (prev.length <= 1) {
        return [
          {
      ...
      <main className="main">
        ...
        {page === "repair" && (
          <RepairPage
            ...
            inputRows={repairInputRows}
            updateInputRow={updateRepairInputRow}
            addInputRow={addRepairInputRow}
